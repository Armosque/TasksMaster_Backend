...
SECRET_KEY = "django-insecure-%!aqi#)&-cpq*5b29fx-qwff&o1_t!&ft8@p&&7+xis6g_eq=v"
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'auten.authentication.JWTAuthentication',  # Usa tu clase de autenticación JWT
    ],
